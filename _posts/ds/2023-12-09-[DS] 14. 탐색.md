...
- 선형 조사법 : 충돌이 일어나면 해시 테이블의 다른 위치를 찾아 항목을 저장한다.
- 체이닝 : 해시 테이블의 하나의 위치가 여러 개의 항목을 저장할 수 있도록 해시 테이블의 구조를 변경한다.
...
하나의 버킷에 여러 개의 레코드를 저장할 수 있도록 하여 체이닝을 해결하는 방법
