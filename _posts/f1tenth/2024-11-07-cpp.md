...
```cpp
control_mean_trajectory_ << 0.1, 0.2, 0.3;
...
```cpp
control_covariance_trajectory_[0] = Eigen::MatrixXd::Identity(CONTROL_SPACE::dim, CONTROL_SPACE::dim) * 1.1;
control_covariance_trajectory_[1] = Eigen::MatrixXd::Identity(CONTROL_SPACE::dim, CONTROL_SPACE::dim) * 1.2;
control_covariance_trajectory_[2] = Eigen::MatrixXd::Identity(CONTROL_SPACE::dim, CONTROL_SPACE::dim) * 1.3;
std::cout << control_covariance_trajectory_[0] << std::endl;
std::cout << control_covariance_trajectory_[1] << std::endl;
std::cout << control_covariance_trajectory_[2] << std::endl;
```
