...
- Dual feasible : a pair $(\lambda, v) \; \text{with} \lambda \geq 0, \text{and} \; g(\lambda, v) > -\infin$
...
### 2.5 Mixed stratedgies for matrix games
...
## 6. Perturbation and sensitiviy analysis

## 7. Exmaples

## 8. Theorems of alternatives

## 9. Generalized inqualities
