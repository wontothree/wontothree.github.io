...
<span style="color: #2D3748; background-color:#fff5b1;">Unlike existing visual foundation models, we aim to develop an object foundation model that directly solve downstream tasks without the need for additional parame- ters or fine-tuning.</span>
