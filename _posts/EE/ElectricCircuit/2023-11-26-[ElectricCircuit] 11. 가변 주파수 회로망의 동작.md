...
- Bode plot : 회로망 특성을 반대수 눈금으로 그린 것. 수직 축은 선형, 수평 축은 대수 눈금으로 그린 것.
...
>
>$$
K_0 \rightarrow 20\log_{10} K_0
$$

>
>The magnitude and the phase of the function - Poles or Zero at the Origin
>
>$$
(j\omega)^{\pm N} \rightarrow \pm 20N \log_{10} \omega, \; \pm N(90^{\circ})
$$

>
>The magnitude and the phase of the function - Simple Pole or Zero
>
>$$
(1 + j\omega\tau) \rightarrow 20\log_{10} |1 + j\omega\tau|, \; \tan^{-1}\omega\tau
>$$
>
>$$
...
>
>The magnitude and the phase of the function - Quadratic Poles or Zeros
>
>$$
1 + 2\xi(j\omega\tau) + (j\omega\tau)^2 \rightarrow 20log_{10} |1 + 2\xi(j\omega\tau) + (j\omega\tau)^2|, \;
