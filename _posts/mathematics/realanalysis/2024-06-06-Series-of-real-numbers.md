...
>Let $\sum a_k$ be a series of positive terms and let $R = \varlimsup_{k \rightarrow \infty} \dfrac{a_{k+1}}{a_k}$, and $r = \varliminf_{k \rightarrow \infty} \dfrac{a_{k+1}}{a_k}$ \
...
>Let $\sum a_k$ be a series of nonnegative terms and let $\alpha = \varlimsup_{k \rightarrow \infty} \sqrt[k]{a_k}$ \
