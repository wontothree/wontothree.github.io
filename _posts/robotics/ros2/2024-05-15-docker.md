...
- f1tenth_gym_ros가 clone되어 있는 경로로 이동한다. 저 repository에서 docker image를 제공하기 때문에 이 경로에서 시작할 수 있다.
- Docker image sim-1와 novnc-1를 실행한다.
...
- http://localhost:8080/vnc.html에서 rviz 환경을 확인하다.
- Vscode로 sim-1 image에 접속하여 코드를 편집한다.
