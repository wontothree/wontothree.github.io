...
|Electronic Components|Utility|Name|Specification|
|---|---|---|---|
...
<span style="color: #2D3748; background-color:#fff5b1;">동력 전달 방식</span>

1. 톱니바퀴
2. 벨트

Cart를 제어하기 위해서는 모터의 전기 에너지를 cart의 위치 에너지로 변환해야 한다.
